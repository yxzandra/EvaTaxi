...
public class DetalleSolicitudManualDialog extends DialogFragment {

    private static final String TAG = "FragmentDetalle";
    private SupportMapFragment mapFragment;
    private static View view;
    static String mtarifa;
    static String mnombre, mtipoTafifa, morigen, mdestino, mpunto;
    ...
    public DetalleSolicitudManualDialog() {
        mapFragment = new SupportMapFragment();
    }

    public static DetalleSolicitudManualDialog newInstance(String tarifa, String nombre, String tipoTarifa,String origen, String destino, String punto) {

        DetalleSolicitudManualDialog f = new DetalleSolicitudManualDialog();
        mtarifa = tarifa;
        mnombre= nombre;
        mtipoTafifa = tipoTarifa;
        morigen = origen;
        mdestino = destino;
        mpunto = punto;

        Log.i(TAG, "newInstance: " + morigen+mdestino+mpunto);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            view = inflater.inflate(R.layout.dialog_detalle_solicitud_manual, container, false);
            //Fragment para el mapa

            getDialog().setTitle("Detalle Solicitud");
        ...
        tv_nombre.setText("Zona seleccionada: " +mnombre);
        tv_tarifa.setText("Tarifa: "+mtarifa  + " BsF.");
        tv_tipo.setText("Tipo de tarifa: "+mtipoTafifa);
        tv_origen.setText("Origen: "+morigen);
        tv_destino.setText("Destino: "+mdestino);
        tv_punto.setText("Punto de referencia: "+mpunto);
    ...
    public void solicitarServicio(View view) {
        ...
        Log.i(TAG, "solicitarServicio: ");serviceManual();
    }
    //generar solicitud manual
    public void serviceManual() {
        RequestSolicitudManual solicitud = new RequestSolicitudManual(idUsuario,mpunto,morigen,mdestino, null);
