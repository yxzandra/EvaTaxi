 ...
 */
public class PagosRealizadosAdapter extends RecyclerView.Adapter<PagosRealizadosAdapter.ViewHolder> {
    private ResponsePaymentsMade paymentsMade;
    private int tipoTransaccion;

    public PagosRealizadosAdapter(ResponsePaymentsMade arrayList, int tipoTransaccion) {
