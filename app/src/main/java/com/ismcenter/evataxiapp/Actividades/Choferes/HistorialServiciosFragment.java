...
import com.ismcenter.evataxiapp.Adaptador.HistorialServiciosAdapter;
...
public class HistorialServiciosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_historial_servicios, container, false);
    ...
    private void cargarAdaptador(ArrayList<ResponseHistoryAcceptService> data) {
        ...
        recyclerView.setAdapter(new HistorialServiciosAdapter(data));
    }
