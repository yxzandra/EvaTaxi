...
import com.ismcenter.evataxiapp.Adaptador.PagosRealizadosAdapter;
...
public class PagosRealizadosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pagos_realizados, container, false);
    ...
    public PagosRealizadosFragment() {
    ...
    private void cargarServicios() {
        ...
        servicio.paymentsMade(Integer.parseInt(idUsuarioFragment)).enqueue(new Callback<ResponsePaymentsMade>() {
            @Override
    ...
    private void cargarAdaptador(ResponsePaymentsMade data) {
        ...
        if (data.getTransferencias().size() != 0) {
            ...
            recyclerTransferencias.setAdapter(new PagosRealizadosAdapter(data, 1));
        ...
        if (data.getDepositos().size() != 0) {
            ...
            recyclerDepositos.setAdapter(new PagosRealizadosAdapter(data, 2));
        ...
        if (data.getInstapago().size() != 0) {
            ...
            recyclerInstapagos.setAdapter(new PagosRealizadosAdapter(data, 3));
